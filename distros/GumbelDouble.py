...
def DDG(gastos, estacion):
    ...
    pl.savefig("salidas/" + estacion + "_grafico_dgumbel_comparacion.png", dpi=1200)
    ...
    pl.savefig("salidas/" + estacion + "_grafico_dgumbel_rosenbrock.png", dpi=1200)
    ...
    pl.savefig("salidas/" + estacion + "_grafico_dgumbel_sin_optimizacion.png", dpi=1200)
    ...
    #fig.show()
    fig.write_html(r"salidas/" + estacion + "_grafico_dgumbel_comparacion.html")
    ...
    #fig.show()
    fig.write_html(r"salidas/" + estacion + "_grafico_dgumbel_rosenbrock.html")
    ...
    #fig.show()
    fig.write_html(r"salidas/" + estacion + "_grafico_dgumbel_sin_optimizacion.html")
